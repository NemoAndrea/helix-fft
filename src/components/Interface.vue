...
<script>
    import HelixDisplay from "./HelixDisplay";
    import FourierPanel from "./FourierPanel";
    ...
    export default {
        ...
        methods: {
            loadExample() {  // load an example via search query string. Will reload the page.
                ...
                //{name:'B-DNA', n:5, m:1, radius:1, rise:0.34, frequency:10, unit_size:0.18, radius:1, rise:0.34, frequency:10, unit_size:0.18}
                // this.$router.push( { path:'', query: new URLSearchParams( 'name=B-DNA&m=1&radius=1&rise=0.34&frequency=10&unit_size=0.18&radius=1&rise=0.34&frequency=10&unit_size=0.18&rotation=143' ).keys() } );
